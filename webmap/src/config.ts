...
// Name→bbox index of PH admin units (adm0–adm3), generated by
// pipelines/02-silver/ph-admin-boundaries/build_admin_search_index.py and hosted
// on public R2. The lookup behind the AI's resolve_region tool.
